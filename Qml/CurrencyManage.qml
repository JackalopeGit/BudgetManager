...
Rectangle {
   ...
   property string label: lang.label( 93 );
   property string secondLabel: lang.label( 97 );
   property var listModel: currencyModel;
   property int maxNameLength: 5
   ...
   Item {
      ...
      MouseArea {
         ...
         width: height
         onClicked: {
            stringCreator.index = listModel.rowCount()
   ...
   Rectangle {
      ...
      z: 12
      property int index: listModel.rowCount()
      Text {
      ...
      CustomButton2 {
         ...
         onClicked: {
            if ( newStringInput.text.length ){
               listModel.insertRows( stringCreator.index, 1 )
               listModel.set( stringCreator.index, newStringInput.text )
               parent.state = "closed"
               Qt.inputMethod.hide();
               newStringInput.text = ""
            } else {
               newStringInput.text = secondLabel + stringCreator.index
            }
         }
      }
   ...
   Rectangle {
      ...
      CustomButton2 {
         ...
         onClicked: {
            ...
            Qt.inputMethod.hide();
            listModel.removeRows( stringEdit.index, 1 )
         }
      }
      Rectangle {
      ...
      CustomButton2 {
         ...
         onClicked: {
            if ( textInput.text.length ){
               listModel.set( stringEdit.index, textInput.text )
               parent.state = "closed"
               Qt.inputMethod.hide();
            } else {
               textInput.text = secondLabel + stringEdit.index
            }
         }
      }
